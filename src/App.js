...
import ApointmentsIntro from './components/Apointments.js'
import ClientView from './components/ClientView.js'

export default ()=>{

  const [clientlist, setClienList] = useState([
    {ClientId: 1, Name: 'Fulano de Tal', Profile: 'https://image.freepik.com/vetores-gratis/perfil-de-avatar-de-homem-no-icone-redondo_24640-14044.jpg'},
    {ClientId: 2, Name: 'Mayara Leandry', Profile: 'https://image.freepik.com/vetores-gratis/perfil-de-avatar-de-homem-no-icone-redondo_24640-14044.jpg'},
    {ClientId: 3, Name: 'Matheus Teixeira', Profile: 'https://image.freepik.com/vetores-gratis/perfil-de-avatar-de-homem-no-icone-redondo_24640-14044.jpg'},
    {ClientId: 4, Name: 'Machadinnn', Profile: 'https://image.freepik.com/vetores-gratis/perfil-de-avatar-de-homem-no-icone-redondo_24640-14044.jpg'},
