...
export default ()=>{
  ...
  useEffect(()=>{
        fetch('http://26.48.46.50:3200/clients')
        .then(res => {
            return res.json()
        })
        .then(data=>{
  ...
  <div className='SideBar'>
    ...
    <header> 
        ...
        <div className='HeaderButtons'>
            <div onClick={handleOpenApointements} className='HeaderBNTHome'> 
    ...
    <div className='ContentArea'>
       ...
       <div>
          <Apointments showApointments={showapointments} setShowApointments={setShowApointments}/>
        <div className='Intro'>
          <h1>Manager</h1>
          <h2>Uma ferramenta para tornar sua gestão Simples!</h2>
        </div>
       </div>
       }
    </div>
